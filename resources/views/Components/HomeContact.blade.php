<div id="contact" class="container-fluid section-marginTop parallax text-center setimage mb-2">
    <div class="dark-overlay">
        <div class="row">
            <div class="col-md-6 contact-form">
                <h5 class="help-line-title"> <i class="fas icon-custom-color fa-headphones-alt"></i> হেলপ লাইন </h5>
                <h5 class="help-line-title m-0"> ০১৭৩০৯৯১৭৪৮ </h5>
            </div>
            <div class="col-md-4 contact-form">
                ...
                <button id="sendmsgid" class="btn btn-block normal-btn w-100">পাঠিয়ে দিন </button>
            </div>
